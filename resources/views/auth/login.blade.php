    ...
    <div class="col-md-5">
        <div class="card border-0 shadow-sm">
            <div class="card-header text-center py-3" 
                ...
                <!-- container box -->
                <div style="width: 140px; height: 140px; border-radius: 12px; overflow:hidden;
                            background-image: url('{{ asset('assets/img/logo-horizontal.png') }}');
